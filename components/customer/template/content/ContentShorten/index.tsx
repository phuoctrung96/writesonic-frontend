...
const formData = (t: Translate): ContentFormData => {
  return {
    ...
    inputs: [
      {
        ...
        minLength: 20,
        rows: 5,
        tooltip: t("inputs:The_text_that_you_would_like_to_shorten"),
        placeholder: t(
    ...
    button: {
      name: t("inputs:Shorten_content"),
      reName: t("inputs:Shorten_content_again"),
    },
  };
};

export default function ContentShorten(props) {

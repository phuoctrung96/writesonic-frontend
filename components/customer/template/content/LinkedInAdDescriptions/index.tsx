...
const formData = (t: Translate): ContentFormData => {
  return {
    endPoint: "linkedin-ad-descriptions",
    inputs: [
      {
        name: "product_name",
    ...
    button: {
      name: t("inputs:Generate_LinkedIn_Ad_Descriptions"),
      reName: t("inputs:Regenerate_LinkedIn_Ad_Descriptions"),
    },
  };
};

export default function LinkedInAdDescriptions(props) {

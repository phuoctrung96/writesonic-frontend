...
const formData = (t: Translate): ContentFormData => {
  return {
    endPoint: "linkedin-ad-headlines",
    inputs: [
      {
        name: "product_name",
    ...
    button: {
      name: t("inputs:Generate_LinkedIn_Ad_Headlines"),
      reName: t("inputs:Regenerate_LinkedIn_Ad_Headlines"),
    },
  };
};

export default function LinkedInAdHeadlines(props) {

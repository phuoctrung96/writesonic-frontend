...
const formData = (t: Translate): ContentFormData => {
  return {
    ...
    button: {
      name: t("inputs:Generate_YouTube_Outlines"),
      reName: t("inputs:Regenerate_YouTube_Outlines"),
    },
  };
};

export default function YouTubeOutlines(props) {

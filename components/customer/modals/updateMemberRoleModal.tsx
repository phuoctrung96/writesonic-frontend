...
import { openUpdateMemberRoleModal } from "../../../store/modals/actions";
...
const UpdateMemberRoleModal: React.FC<{
  ...
  const handleUpdate = async () => {
    try {
      ...
      onSuccess(member);
      dispatch(openUpdateMemberRoleModal(false));
    } catch (err) {
  ...
  const openModal = (open: boolean) => {
    dispatch(openUpdateMemberRoleModal(open));
  };
...
const mapStateToPros = (state) => {
  return {
    isOpenModal: state.modals?.isOpenUpdateMemberRoleModal,
  };
};

export default connect(mapStateToPros)(UpdateMemberRoleModal);
